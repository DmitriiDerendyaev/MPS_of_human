...
#define button3    2     // button B3 is connected to Arduino pin 2
#define button4    8     // button B4 is connected to Arduino pin 8
...
void alarm ()
{
  tft.setCursor(35, 53);               // move cursor to position (4, 30) pixel
