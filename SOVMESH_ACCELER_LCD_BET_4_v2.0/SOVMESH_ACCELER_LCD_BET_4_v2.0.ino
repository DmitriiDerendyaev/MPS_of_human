...
// buttons definition
#define button1    3     // button B1 is connected to Arduino pin 3 set_sos
#define button2    4     // button B2 is connected to Arduino pin 4 sel_res
